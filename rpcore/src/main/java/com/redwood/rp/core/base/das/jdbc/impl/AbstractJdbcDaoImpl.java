package com.redwood.rp.core.base.das.jdbc.impl;
/**
 *=====================================================================
...
public abstract class AbstractJdbcDaoImpl extends NamedParameterJdbcDaoSupport implements AbstractJdbcDao {
	private Logger logger = LoggerFactory.getLogger(AbstractJdbcDaoImpl.class.getName());
    ...
    public List<Map<String, Object>> executeJdbcQuery(String query, Map<String, Object> paramMap) throws DaoException {
        ...
        try {
            resultList = getNamedParameterJdbcTemplate().queryForList(query, paramMap);
        } catch (DataAccessException e) {
            errorDescription = "Failed to excute the query " + query
                + " . The system error is :" + e.getMessage();
            errorDescription = errorDescription + "The given query is :  <query start >  "
                + query + "   <query end >";
    ...
    public int executeJdbcUpdate(String query, Map<String, Object> paramMap) throws DaoException {
        ...
        try {
            ...
            logger.error(MessageFormattor.errorFormat(this.getClass().getName(),
                "executeNamedQuery", ExceptionType.EXCEPTION_DAO, errorDescription), e);
            throw new DaoException(ExceptionType.EXCEPTION_DAO,
					new ErrorVO(ErrorDescription.ERR_CD_DAO_INSERT_OR_UPDATE,ErrorDescription.ERR_MSG_DAO_INSERT_OR_UPDATE, errorDescription));
        } catch (Exception e) {
            errorDescription = "Failed to excute the query " + query
                + " . The system error is :" + e.getMessage();
            errorDescription = errorDescription + "The given query is :  <query start >  "
    ...
    public int[] executeJdbcBatchUpdate(String query, Map<String, ?>[] batchValues) throws DaoException {
        ...
        String errorDescription = "";
        try {
            counts = getNamedParameterJdbcTemplate().batchUpdate(query, batchValues);
        } catch (DataAccessException e) {
            errorDescription = "Failed to excute the query " + query
                + " . The system error is :" + e.getMessage();
            errorDescription = errorDescription + "The given query is :  <query start >  "
    ...
    public int executeJdbcUpdate(String query,  SqlParameterSource paramSource, KeyHolder generatedKeyHolder) throws DaoException {
        ...
        String errorDescription = "";
        try {
            count = getNamedParameterJdbcTemplate().update(query, paramSource, generatedKeyHolder);
        } catch (DataAccessException e) {
            errorDescription = "Failed to excute the query " + query
                + " . The system error is :" + e.getMessage();
            errorDescription = errorDescription + "The given query is :  <query start >  "
                + query + "   <query end >";
            logger.error(MessageFormattor.errorFormat(this.getClass().getName(),
                "executeJdbcUpdate", ExceptionType.EXCEPTION_DAO, errorDescription), e);
            throw new DaoException(ExceptionType.EXCEPTION_DAO,
					new ErrorVO(ErrorDescription.ERR_CD_DAO_INSERT_OR_UPDATE,ErrorDescription.ERR_MSG_DAO_INSERT_OR_UPDATE, errorDescription));
        } catch (Exception e) {
            errorDescription = "Failed to excute the query " + query
    ...
    public int executeSimpleQuery(String query, Map<String, String> paramMap) throws DaoException {
        ...
        String errorDescription = "";
        try {
            count = getNamedParameterJdbcTemplate().queryForInt(query, paramMap);
        } catch (DataAccessException e) {
            errorDescription = "Failed to excute the query " + query
                + " . The system error is :" + e.getMessage();
            errorDescription = errorDescription + "The given query is :  <query start >  "
     ...
     * @throws DaoException
     */
    public List<Map<String, Object>> executeJdbcStoredProcedure(final String procedureString, final Map<String, String> paramMap) throws DaoException {
    	String errorMsg = "";
        ...
        try {
            ...
            Map<String, Object> spResultMap = getJdbcTemplate().call(new CallableStatementCreator() {
                @Override
                public CallableStatement createCallableStatement(Connection con) throws SQLException {
                	CallableStatement cstmt = null;
                	String callableStr = getCallableStr(procedureString, paramMap.size());
                    cstmt =   con.prepareCall(callableStr);
                    Iterator<String> paramValues = paramMap.values().iterator();
                    int index = 1; 
            ...
            resultList = (List<Map<String, Object>>)spResultMap.get("result-set");
        } catch (DataAccessException e) {
            errorMsg = "Failed to excute the SP " + procedureString + " . The system error is :" + e.getMessage();
            errorMsg = errorMsg + "The given query is :  <query start >  "+ procedureString + "   <query end >";
            logger.error(MessageFormattor.errorFormat(this.getClass().getName(), "executeJdbcStoredProcedure", ExceptionType.EXCEPTION_DAO, errorMsg), e);
            throw new DaoException(ExceptionType.EXCEPTION_DAO, new ErrorVO(ErrorDescription.ERR_CD_DAO_QUERY,ErrorDescription.ERR_MSG_DAO_QUERY, errorMsg));
        } catch (Exception e) {
            errorMsg = "Failed to excute the SP " + procedureString + " . The system error is :" + e.getMessage();
            errorMsg = errorMsg + "The given query is :  <query start >  " + procedureString + "   <query end >";
            logger.error(MessageFormattor.errorFormat(this.getClass().getName(), "executeJdbcStoredProcedure", ExceptionType.EXCEPTION_DAO, errorMsg), e);
